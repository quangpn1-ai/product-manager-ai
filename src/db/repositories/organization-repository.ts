...
function getDefaultWorkflow() {
  return {
    ...
    inputs: {
      ...
      clarificationJson: { required: true },
      contextItemsJson: { required: false },
    },
    stateMachine: {
    ...
    stages: [
      {
        id: 'gen',
        role: 'generator',
        promptTemplateKey: 'pt_gen_brief_v1',
        provider: 'openai',
        model: 'gpt-4o',
        timeoutMs: 45000,
        retries: 1,
        fallback: [{ provider: 'google', model: 'gemini-1.5-pro' }],
        outputSchemaId: 'schema_gen_brief_v1',
      },
      {
        id: 'critic',
        role: 'critic',
        promptTemplateKey: 'pt_critic_v1',
        provider: 'anthropic',
        model: 'claude-3-5-sonnet-20241022',
        timeoutMs: 45000,
        retries: 1,
        outputSchemaId: 'schema_critic_v1',
      },
      {
        id: 'xq',
        role: 'cross_questioner',
        promptTemplateKey: 'pt_xq_v1',
        provider: 'google',
        model: 'gemini-1.5-pro',
        timeoutMs: 45000,
        retries: 1,
        outputSchemaId: 'schema_xq_v1',
      },
      {
        id: 'syn',
        role: 'synthesizer',
        promptTemplateKey: 'pt_synth_v1',
        provider: 'openai',
        model: 'gpt-4o',
        timeoutMs: 60000,
        retries: 1,
        fallback: [{ provider: 'anthropic', model: 'claude-3-5-sonnet-20241022' }],
        outputSchemaId: 'schema_product_brief_v1',
      },
    ],
    finalOutputSchemaId: 'schema_product_brief_v1',
  };
}
